...
package ada_main is
   ...
   u00398 : constant Version_32 := 16#c1e82464#;
   pragma Export (C, u00398, "lr__synchroB");
   u00399 : constant Version_32 := 16#6f87cbb4#;
   pragma Export (C, u00399, "lr__synchroS");
   u00400 : constant Version_32 := 16#f9019ac0#;
   pragma Export (C, u00400, "lr__synchro__automateB");
   u00401 : constant Version_32 := 16#76bdc5c1#;
   pragma Export (C, u00401, "lr__synchro__automateS");
   ...
   u00457 : constant Version_32 := 16#16c1e8cf#;
   pragma Export (C, u00457, "lr__synchro__basiqueB");
   u00458 : constant Version_32 := 16#98c199c5#;
   pragma Export (C, u00458, "lr__synchro__basiqueS");
   ...
   u00461 : constant Version_32 := 16#ec9cfed1#;
   pragma Export (C, u00461, "system__random_numbersB");
   u00462 : constant Version_32 := 16#852d5c9e#;
   pragma Export (C, u00462, "system__random_numbersS");
   u00463 : constant Version_32 := 16#e0ac52ca#;
   pragma Export (C, u00463, "system__random_seedB");
   u00464 : constant Version_32 := 16#1d25c55f#;
   pragma Export (C, u00464, "system__random_seedS");
   u00465 : constant Version_32 := 16#1d9142a4#;
   pragma Export (C, u00465, "system__val_unsB");
   u00466 : constant Version_32 := 16#621b7dbc#;
   pragma Export (C, u00466, "system__val_unsS");
   u00467 : constant Version_32 := 16#d763507a#;
   pragma Export (C, u00467, "system__val_intB");
   u00468 : constant Version_32 := 16#0e90c63b#;
   pragma Export (C, u00468, "system__val_intS");
   ...
   --  lr.synchro.automate%s
   --  lr.synchro.automate%b
